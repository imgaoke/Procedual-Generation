...
import cz.cuni.gamedev.nail123.roguelike.world.worlds.MyJavaWorld
import cz.cuni.gamedev.nail123.roguelike.world.worlds.MyJavaWorldSubmission
...
object GameConfig {
    fun defaultWorld(): World = MyJavaWorldSubmission()
