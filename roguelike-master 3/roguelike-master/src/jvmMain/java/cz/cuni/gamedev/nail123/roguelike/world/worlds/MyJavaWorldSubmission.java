...
public class MyJavaWorldSubmission extends World {
    int currentLevel = 0;
    List<Room> rooms;
    ...
    public class Room{
        ...
        Position3D center;
        // halfWidth and halfHeight does not include the middle floor of the room, the wall is included in width or height so the smallest value is 1
        int halfWidth;
        int halfHeight;
        int componentNumber;

        public Room(Position3D center, int halfWidth, int halfHeight, int componentNumber){
            this.center = center;
        ...
        public Room createRandomRoom(AreaBuilder areaBuilder){
            ...
            return new Room(center, halfWidth, halfHeight, 0);
    ...
    public class Cell{
        ...
        // one cell maybe has more than one child, but here the usage of the child is for truncating the path
        // of DFS from the starting point to the point where there's more than 1 child
    ...
    // filtering start position of DFS
    ...
    public List<Cell> roomProbe(Room room, List<Room> rooms, AreaBuilder areaBuilder){
        ...
        // because for the corridor including its walls, width is at least 3 so only probe 2 to 3 offsets outside the room
    ...
    Area buildLevel() {
        ...
        // create rooms with 200 iterations
        int iteration = 0;
        this.rooms = new ArrayList<Room>();
        Room roomFactory = new Room(Position3D.create(0, 0, 0),0,0, 0);
        ...
        // run DFS for the rest of the map other than the rooms
